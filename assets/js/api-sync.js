    ...
    async function syncArticles() {
        ...
        try {
            ...
            articles.slice(0, 3).forEach(post => {
                ...
                // LOGIKA GAMBAR: Kalau ada thumbnail, tampilin. Kalau nggak, pakai placeholder gradient.
                ...
                <article class="group bg-white rounded-[2.5rem] p-2 border border-slate-100 hover:border-emerald-200 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-900/5">
                    ...
                    <div class="px-6 pb-8">
                        ...
                        <button onclick="getArticleBySlug('${post.slug}')" class="inline-flex items-center text-[10px] font-black uppercase tracking-widest text-emerald-600 group-hover:text-slate-800 transition-all">
                            Baca Selengkapnya 
