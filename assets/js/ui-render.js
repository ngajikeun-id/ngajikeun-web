...
`}
    ...
    <div class="group bg-slate-900 rounded-[2rem] overflow-hidden border border-slate-800 hover:shadow-2xl hover:shadow-emerald-950/30 transition-all duration-500">
        ...
        <div class="p-8">
            ...
            <a
        href="/dashboard/daftar/?program=${safeText(slug)}"
        class="flex items-center justify-center py-4 bg-emerald-600 text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-emerald-500">
